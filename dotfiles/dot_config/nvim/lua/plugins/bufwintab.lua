    ...
    keys = {
      {
        ...
        desc = "smart-split: Move focus to the left adjacent window",
      },
      {
        "<M-j>",
        function()
        ...
        desc = "smart-split: Move focus to the down adjacent window",
      },
      {
        "<M-k>",
        function()
        ...
        desc = "smart-split: Move focus to the up adjacent window",
      },
      {
        "<M-l>",
        function()
        ...
        desc = "smart-split: Move focus to the right adjacent window",
      },
      {
        "<C-M-h>",
        function()
        ...
        desc = "smart-split: Resize window left",
      },
      {
        "<C-M-j>",
        function()
        ...
        desc = "smart-split: Resize window up",
      },
      {
        "<C-M-k>",
        function()
        ...
        desc = "smart-split: Resize window down",
      },
      {
        "<C-M-l>",
        function()
        ...
        desc = "smart-split: Resize window right",
      },
