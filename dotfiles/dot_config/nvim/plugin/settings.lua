...
-- vim.o.shellslash = true -- setting this is necessary for yazi.nvim to work, but when set globally it breaks some things (e.g. metals generate workspaces for each directory)
