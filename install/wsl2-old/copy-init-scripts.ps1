...
Write-Host "--- init2.sh ---"
wsl -d $distro --cd ~ cp /mnt/c/Users/adamr/setup/install/wsl2/init2.sh ~
#wsl -d $distro --cd ~ ~/init2.sh

Write-Host "--- init3.sh ---"
wsl -d $distro --cd ~ cp /mnt/c/Users/adamr/setup/install/wsl2/init3.sh ~
#wsl -d $distro --cd ~ setup/install/wsl2/init3.sh
